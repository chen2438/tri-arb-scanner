...
const opportunity: Opportunity = {
  ...
  legs: [
    { symbol: "BTCUSDT", side: "BUY", from_asset: "USDT", to_asset: "BTC", input_amount: "100", output_amount: "0.0015", average_price: "66666.6", fee_rate: "0.001", fee_amount: "0.0000015", dust_amount: "0", levels_consumed: 2, book_version: "1", source_time: "2026-07-21T12:00:00.000Z", received_time: "2026-07-21T12:00:00.010Z" },
    { symbol: "ETHBTC", side: "BUY", from_asset: "BTC", to_asset: "ETH", input_amount: "0.0015", output_amount: "0.03", average_price: "0.05", fee_rate: "0.001", fee_amount: "0.00003", dust_amount: "0", levels_consumed: 1, book_version: "2", source_time: "2026-07-21T12:00:00.003Z", received_time: "2026-07-21T12:00:00.012Z" },
    { symbol: "ETHUSDT", side: "SELL", from_asset: "ETH", to_asset: "USDT", input_amount: "0.03", output_amount: "100.32", average_price: "3344", fee_rate: "0.001", fee_amount: "0.10032", dust_amount: "0", levels_consumed: 1, book_version: "3", source_time: "2026-07-21T12:00:00.004Z", received_time: "2026-07-21T12:00:00.014Z" },
  ],
};

const scanner = {
  live: { connection: "connected" as const, sequence: 4, awaitingSnapshot: false, resyncRequired: false, opportunities: [opportunity], status: { phase: "scanning", ready: true, market_count: 2040, route_count: 736, ticker_count: 2040, depth_book_count: 6, subscription_count: 6, active_opportunity_count: 1, rest_metadata_age_ms: 1000, rest_clock_age_ms: 2000, rest_ticker_age_ms: 250, last_scan_at: "2026-07-21T12:00:01.000Z", last_error: null, websocket_connections: [{ shard_id: 0, state: "connected", generation: 2, subscription_count: 6, error: null }] } },
