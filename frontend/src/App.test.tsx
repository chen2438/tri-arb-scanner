...
const exchangeStatus = { exchange: "MEXC", phase: "ready", ready: true, market_count: 2040, route_count: 736, ticker_count: 2040, market_activity_count: 2040, core_market_count: 30, core_route_count: 48, depth_book_count: 6, subscription_count: 6, rest_metadata_age_ms: 1000, rest_clock_age_ms: 2000, rest_ticker_age_ms: 250, rest_price_reference_age_ms: 500, rest_market_activity_age_ms: 800, last_error: null, websocket_connections: [{ exchange: "MEXC", shard_id: 0, state: "connected", generation: 2, subscription_count: 6, error: null }] };
...
const scanner = {
  ...
  config: { anchor_asset: "USDT", anchor_assets: ["USDT", "USDC", "USD1"], notional: "100", min_net_return_bps: "20", safety_buffer_bps: "5", depth_levels: 20, okx_enabled: true, okx_taker_commission: "0.001" },
