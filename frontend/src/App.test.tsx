...
const scanner = {
  ...
  config: { anchor_asset: "USDT", anchor_assets: ["USDT", "USDC", "USD1"], notional: "100", min_net_return_bps: "20", safety_buffer_bps: "5", depth_levels: 20, okx_enabled: true, okx_taker_commission: "0.0015", binance_enabled: true, binance_taker_commission: "0.001" },
